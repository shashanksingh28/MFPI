...
public class ViewHelper {
    ...
    public static Group fetchGroupDetailsFromView(View view_Layout) {
        ...
        if (groupNameEditor != null && groupNameEditor.getText() != null)
            updatedGroup.Name = groupNameEditor.getText().toString();
        ...
        if (president_spinner.getSelectedItem() != null)
        ...
        if (secretary_spinner.getSelectedItem() != null)
            updatedGroup.Secretary = ((Member) (secretary_spinner.getSelectedItem()));

        Spinner treasurer_spinner = (Spinner) view.findViewById(R.id.sp_group_treasurer);
        if (treasurer_spinner.getSelectedItem() != null)
        ...
        if (grpRecurringSavingsEditor != null && grpRecurringSavingsEditor.getText() != null) {
            ...
            if (savings != null && !savings.isEmpty())
                updatedGroup.MonthlyCompulsoryAmount = Float.parseFloat(savings);
        }
        ...
        Spinner grpMonthlyMeetDate = (Spinner) view.findViewById(R.id.group_mmd_date);
        if (grpMonthlyMeetDate != null && grpMonthlyMeetDate.getSelectedItem() != "")
            updatedGroup.MonthlyMeetingDate = Integer.parseInt(grpMonthlyMeetDate.getSelectedItem().toString())-1;
